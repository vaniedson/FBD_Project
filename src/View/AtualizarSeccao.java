...
// */
//public class AtualizarSeccao extends JFrame {
//
//    private Model.Seccao modelo;
...
//
//    public AtualizarSeccao(Model.Seccao md, int id, int linha) {
//        super("Contatos");
//        criaJanela();
//        modelo = md;
//        Seccao dao = new Seccao();
//        Seccao = dao.getContatoById(id);
//        txId.setText(Integer.toString(Seccao.getId()));
//        txNome.setText(Seccao.getNome());
//        txTelefone.setText(Seccao.getDescricao());
